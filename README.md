About torchts-feedstock
=======================

Feedstock license: [BSD-3-Clause](https://github.com/conda-forge/torchts-feedstock/blob/main/LICENSE.txt)
...
<table><tr><td>All platforms:</td>
    <td>
      <a href="https://dev.azure.com/conda-forge/feedstock-builds/_build/latest?definitionId=13757&branchName=main">
        <img src="https://dev.azure.com/conda-forge/feedstock-builds/_apis/build/status/torchts-feedstock?branchName=main">
      </a>
    </td>
  </tr>
</table>
...
Once the `conda-forge` channel has been enabled, `torchts` can be installed with `conda`:
...
```
mamba install torchts
```

It is possible to list all of the versions of `torchts` available on your platform with `conda`:
...
```
mamba search torchts --channel conda-forge
```
...
mamba repoquery search torchts --channel conda-forge

# List packages depending on `torchts`:
mamba repoquery whoneeds torchts --channel conda-forge

# List dependencies of `torchts`:
mamba repoquery depends torchts --channel conda-forge
```
